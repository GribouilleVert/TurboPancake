...
class ValidationError {
    ...
    private $messages = [
        ...
        'mimes'             => 'Le fichier que vous avez envoyé doit être parmis les types mimes suivants: %s.',
        'regexMime'         => 'Le fichier que vous avez envoyé doit être de type mime compatible avec cette expression régulière: %s.',
